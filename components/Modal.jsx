              ...
              <div>
                  ...
                  <div className='mt-3 text-center sm:mt-5'>
                    ...
                    <div className='mt-2'>
                      <input
                        ...
                        type='text'
                        ref={captionRef}
                        placeholder='Plaese enter a caption'
                      />
                    </div>
                  </div>
                </div>
                <div className='mt-5 sm:mt-6'>
                  <button
                    ...
                    className='inline-flex justify-center w-full rounded-md border border-transparent shadow-sm px-4 py-2 bg-red-600 text-base font-medium hover:bg-red-700 
                    focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 sm:text-sm disabled:bg-gray-300 disabled:cursor-not-allowed hover:disabled:bg-gray-300'
                    onClick={uploadPost}
                  >
